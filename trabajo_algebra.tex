...
Cada componente s\_i representa la amplitud o fase de la señal en un instante concreto. De esta
...
Siendo A una matriz mxn, la transformación de un vector de datos se expresa como y = Ax ,
...
$=3\equiv 1\;(\mathrm{mod}\;2)$

Dado que: $Hr\neq 0$.

Se concluye que el vector recibido no pertenece al subespacio de códigos válidos, es decir,
...
$\hat{c}=\begin{pmatrix}1 \\ 0 \\ 1\end{pmatrix}$
...
AN ALGEBRAIC ATTACK TO THE BLUETOOTH STREAM
CIPHER E0 (https://eprint.iacr.org/2022/016.pdf)
The Confidentiality - Integrity - Accessibility Triad into the
Knowledge Security. A Reassessment from the Point of View of the
Knowledge Contribution to Innovation
(https://www.researchgate.net/publication/257985911\_The\_Confidential
ity\_-\_Integrity\_-
\_Accessibility\_Triad\_into\_the\_Knowledge\_Security\_A\_Reassessment\_f
rom\_the\_Point\_of\_View\_of\_the\_Knowledge\_Contribution\_to\_Innovati
on)

Gallager, R. G. Principles of Digital Communication. Cambridge University Press, 2008.

Parity-check matrix (https://www.sciencedirect.com/topics/computer-science/parity-
check-matrix)

Lay, D. C. (2012). Linear Algebra and Its Applications. Pearson.

Lin, S., \& Costello, D. (2004). Error Control Coding. Pearson.
...
Se ha usado IA (ChatGPT/Gemini) para correcciones ortográficas, organización del
documento y "proofreading".
