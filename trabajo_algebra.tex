...
Este trabajo nos ha permitido conocer y analizar los fundamentos matemáticos que forman y dan lugar a el estándar de comunicación inalámbrica Bluetooth a partir de bases matemáticas 

A lo largo del desarrollo, se ha podido ver cómo la información digital y las señales de radio pueden ser modeladas con precisión mediante vectores en espacios multidimensionales y cuerpos finitos. En primer lugar, se ha detallado cómo estas señales se estructuran y protegen antes de su emisión, empleando matrices generadoras y de control de paridad para introducir redundancia y anticiparse a los errores de transmisión. Posteriormente, se ha abordado la naturaleza física de la radiofrecuencia mediante la modelización del canal inalámbrico; aquí, el uso de matrices de transformación ha permitido abstraer los efectos del ruido y la multitrayectoria, demostrando que el receptor logra recuperar el mensaje original calculando proyecciones ortogonales sobre subespacios de códigos válidos. Finalmente, el análisis de los protocolos de seguridad ha revelado que la protección de los datos frente a interceptaciones externas depende directamente de operaciones sobre cuerpos de Galois, donde la robustez del cifrado E0 se sostiene sobre la complejidad de resolver sistemas masivos de ecuaciones lineales booleanas. 

Hoy en día la tecnología Bluethooth es una de las tecnologías más usadas a nivel mundial que sigue evolucionando progresivamente, uno de los objetivos es poder reforzar la seguridad de las claves incluyendo algoritmos criptograficos-cuanticos lo que dará lugar a ecuaciones matemáticas más complejas y sofisticadas cada vez mas  

Este trabajo es un claro ejemplo de lo importante y fundamental que es el algebra, Debido a que ofrece un lenguaje universal y carece de ambigüedad proporcionando así las bases de cualquier rama tecnológica 
\newpage
